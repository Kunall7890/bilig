export const docsSiteSources = [
  ...
  ['.well-known/agent-skills/bilig-workpaper/SKILL.md', '.well-known/agent-skills/bilig-workpaper/SKILL.md'],
  ['.well-known/skills/index.json', '.well-known/skills/index.json'],
  ['.well-known/skills/bilig-workpaper/SKILL.md', '.well-known/skills/bilig-workpaper/SKILL.md'],
  ['AGENTS.md', 'AGENTS.md'],
  ['skill.md', 'skill.md'],

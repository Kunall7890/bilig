export const docsSiteSources = [
  ...
  ['agent-proof-transcripts.html', 'agent-proof-transcripts.md'],
  ['agent-proof-transcripts/codex.html', 'agent-proof-transcripts/codex.md'],
  ['agent-proof-transcripts/claude-code.html', 'agent-proof-transcripts/claude-code.md'],
  ['agent-proof-transcripts/copilot.html', 'agent-proof-transcripts/copilot.md'],
  ['agent-proof-transcripts/cursor.html', 'agent-proof-transcripts/cursor.md'],
  ['agent-proof-transcripts/continue.html', 'agent-proof-transcripts/continue.md'],
  ...
  ['prefect-workpaper-flow.html', 'prefect-workpaper-flow.md'],

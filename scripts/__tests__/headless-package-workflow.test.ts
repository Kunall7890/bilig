...
describe('headless package workflow', () => {
  ...
  it('keeps publish, benchmark, and clean consumer smoke gates in the package workflow', () => {
    ...
    expect(source).toContain('Wait for github-ci success before publishing')
    ...
    const runtimeGreenCiGateIndex = source.indexOf('Wait for github-ci success before publishing')
    expect(runtimeGreenCiGateIndex).toBeGreaterThan(source.indexOf('Release metadata SHA: ${head_sha}'))

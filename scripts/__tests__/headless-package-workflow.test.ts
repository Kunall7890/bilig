...
describe('headless package workflow', () => {
  ...
  it('keeps publish, benchmark, and clean consumer smoke gates in the package workflow', () => {
    ...
    expect(source).toContain('packages/benchmarks/baselines/workpaper-vs-ironcalc-rust.json')
    expect(source).toContain('packages/benchmarks/baselines/headless-performance-leadership-scorecard.json')
    ...
    expect(rendererInstallIndex).toBeLessThan(benchmarkCardSyncIndex)
    expect(ironCalcReleaseEvidenceIndex).toBeGreaterThan(releaseMetadataSyncIndex)
    expect(ironCalcReleaseEvidenceIndex).toBeLessThan(releaseEvidenceSyncIndex)
    expect(benchmarkCardSyncIndex).toBeGreaterThan(releaseEvidenceSyncIndex)
    expect(benchmarkCardSyncIndex).toBeLessThan(agentDiscoverySyncIndex)

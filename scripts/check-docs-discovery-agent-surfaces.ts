...
export async function requireAgentPublicSurfaceDiscovery(input: {
  ...
  for (const required of [
    ...
    'Goose MCP catalog               | Submitted for maintainer review; catalog command and PR body refreshed on May 19',
    ...
    'Live; `0.25.7` is latest-marked and matches npm',
    ...
    'official Registry latest-marked entry is\n`io.github.proompteng/bilig-workpaper@0.25.7`',

...
export async function requireAgentPublicSurfaceDiscovery(input: {
  ...
  requireIncludes(jekyllDefaultLayout, 'href="{{ \'/assets/site.css?v=2026-05-30-3\' | relative_url }}"', 'docs/_layouts/default.html')
  requireIncludes(jekyllDefaultLayout, 'src="{{ \'/assets/site-nav.js?v=2026-05-30-3\' | relative_url }}"', 'docs/_layouts/default.html')

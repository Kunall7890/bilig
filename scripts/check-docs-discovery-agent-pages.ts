...
export const agentFrameworkDocRequirements = [
  ...
  {
    path: 'docs/aider-workpaper-conventions.md',
    includes: [
      ...
      '@bilig/workpaper@latest',
      'bilig-evaluate --door agent-mcp --json',
      'bilig-evaluate --door agent-mcp --scenario provider-backed --json',
      'bilig-workpaper-mcp --workpaper ./.bilig/pricing.workpaper.json --init-demo-workpaper --writable',
      'bilig-workpaper-mcp --from-xlsx ./pricing.xlsx',
      'verified: true',
      'A write call alone is not proof',
      'npm publishing can lag the repository',
    ],
  },
  {

...
import { readSameCorpusVisibleSelectedRange, readSameCorpusVisibleSheetId } from './ui-responsiveness-same-corpus-visible-readback.ts'
import {
...
export {
  readGoogleSheetsNameBoxSelection,
  readSameCorpusVisibleSelectedRange,
  readSameCorpusVisibleSheetId,
  type SameCorpusNameBoxReaderPage,
} from './ui-responsiveness-same-corpus-visible-readback.ts'

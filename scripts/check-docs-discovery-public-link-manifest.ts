...
export const homepageRequiredLinks = [
  ...
  './langgraph-workpaper-toolnode-spreadsheet.html',
  './llamaindex-workpaper-spreadsheet-tool.html',
  './crewai-workpaper-spreadsheet-tool.html',
  './cloudflare-agents-workpaper-spreadsheet-tool.html',
  './semantic-kernel-workpaper-mcp.html',
  './gemini-cli-workpaper-extension.html',
  './xlsx-formula-recalculation-node.html',
  './xlsx-recalculation-proof.html',
  './xlsx-recalculation-proof.ts',
  './external-workbook-recalc-proof.html',
  './external-workbook-recalc-proof.ts',
  ...
  './directus-workpaper-flow-operation.html',
  './windmill-workpaper-script.html',
  './triggerdev-workpaper-task.html',
  './inngest-workpaper-step.html',
  './airbyte-workpaper-validation.html',
  './meltano-workpaper-utility.html',
  './temporal-workpaper-activity.html',
  './airflow-workpaper-dag.html',
  './dagster-workpaper-asset.html',
  './kestra-workpaper-flow.html',
  './prefect-workpaper-flow.html',
  './open-webui-workpaper-mcp.html',
  './open-multi-agent-workpaper-mcp.html',
  './lobehub-workpaper-mcp.html',
  './anythingllm-workpaper-mcp.html',
  './fastmcp-workpaper-client.html',
...
export const llmsRequiredLinks = [
  ...
  'npx --package @bilig/xlsx-formula-recalc xlsx-cache-doctor pricing.xlsx',
  ...
  'https://proompteng.github.io/bilig/xlsx-cache-doctor-github-action.html',
  'https://github.com/proompteng/bilig/blob/main/docs/xlsx-cache-doctor-github-action.md',
  ...
  'https://proompteng.github.io/bilig/eval-xlsx-cache-doctor.html',

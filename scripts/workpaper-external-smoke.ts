...
import {
  parsePackageMcpXlsxRiskOutput,
  writeMcpXlsxRiskFixtureScript,
  type PackageMcpXlsxRiskSummary,
} from './workpaper-external-smoke-mcp-xlsx-risk.ts'
...
function runNodeSmoke(
  ...
  packageMcpXlsxRisk: PackageMcpXlsxRiskSummary
  mcpChallenge: {
    editedCell: string

...
function sameCorpusMutationTargetProofSampleSummaries(
  ...
  return Array.from({ length: requiredSampleCount }, (_, sampleIndex) => {
    ...
    return {
      ...
      visibleTargetRenderMs: sample.visibleTargetRenderMs,
      committedStateValidationMs: sample.committedStateValidationMs,
      restoreValidationMs: sample.restoreValidationMs,
      operationStartedAtMs: sample.operationStartedAtMs,
      visibleTargetRenderCapturedAtMs: sample.visibleTargetRenderCapturedAtMs,
      postMutationProofCapturedAtMs: sample.postMutationProofCapturedAtMs,
      restoreProofCapturedAtMs: sample.restoreProofCapturedAtMs,
      ...
      committedStateProof: sample.committedStateProof ?? null,

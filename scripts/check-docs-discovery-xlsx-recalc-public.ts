...
export function requireXlsxRecalcPublicDiscovery(args: {
  ...
  requireIncludes(args.index, 'Pick the SheetJS-named package', 'docs/index.html')
  requireIncludes(args.index, 'before moving to a full workbook runtime', 'docs/index.html')

...
export function requireXlsxRecalcPublicDiscovery(args: {
  ...
  requireIncludes(args.index, 'Use <code>@bilig/xlsx-formula-recalc</code> and the cache doctor when a saved', 'docs/index.html')
  requireIncludes(args.index, 'SheetJS, xlsx-populate, and ExcelJS bridge example', 'docs/index.html')
  requireIncludes(args.index, './xlsx-formula-recalculation-node.html', 'docs/index.html')
  requireIncludes(args.index, './eval-xlsx-cache-doctor.html', 'docs/index.html')

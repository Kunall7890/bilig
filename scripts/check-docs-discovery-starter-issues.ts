...
const closedStarterIssueNumbers = [
  ...
  273, 283, 300, 360, 361, 362, 363, 366, 367, 368, 369, 371, 358, 334, 452, 453, 454,
] as const
...
export function requireStarterIssueDiscovery(inputsOrStarterIssues: StarterIssueDiscoveryInputs | string, maybeLlms?: string): void {
  ...
  requireIncludes(starterIssues, 'No starter issue is open this week.', 'docs/starter-issues.md')
  requireIncludes(starterIssues, '## Code And Test Starters', 'docs/starter-issues.md')
  requireIncludes(starterIssues, 'No code or test starter is open this week.', 'docs/starter-issues.md')
  requireIncludes(starterIssues, '## Integration Docs Starters', 'docs/starter-issues.md')
  requireIncludes(starterIssues, 'No integration docs starter is open this week.', 'docs/starter-issues.md')

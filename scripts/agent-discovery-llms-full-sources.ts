...
const llmsFullSourceSpecs = [
  ...
  ['Agent WorkPaper Handoff', 'docs/agent-adoption-kit.md'],
  ...
  ['Agent Proof Transcripts', 'docs/agent-proof-transcripts.md'],
  ['Codex WorkPaper Proof Transcript', 'docs/agent-proof-transcripts/codex.md'],
  ['Claude Code WorkPaper Proof Transcript', 'docs/agent-proof-transcripts/claude-code.md'],
  ['GitHub Copilot WorkPaper Proof Transcript', 'docs/agent-proof-transcripts/copilot.md'],
  ['Cursor WorkPaper Proof Transcript', 'docs/agent-proof-transcripts/cursor.md'],
  ['Continue WorkPaper Proof Transcript', 'docs/agent-proof-transcripts/continue.md'],
  ...
  ['WorkPaper Agent Tool For Node.js', 'docs/ai-agent-spreadsheet-tool-node.md'],

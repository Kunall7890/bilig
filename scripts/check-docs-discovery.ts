...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-4" />', 'docs/index.html')
...
requireIncludes(index, '<strong>45 starter tasks</strong>', 'docs/index.html')
requireIncludes(index, '<strong>0.13.14</strong>', 'docs/index.html')
requireIncludes(index, '<span>Open first-timer issues</span>', 'docs/index.html')
requireIncludes(index, '<strong>45</strong>', 'docs/index.html')

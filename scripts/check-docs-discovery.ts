...
for (const required of [
  ...
  'Live, current npm version indexed',
  ...
  `Registry API now includes the current \`@bilig/headless@${headlessPackageVersion}\` package version`,
  ...
  `official Registry API search now includes Bilig WorkPaper entry version\n\`${headlessPackageVersion}\``,
  'with `isLatest: true`',

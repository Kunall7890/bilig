...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-11" />', 'docs/index.html')
...
requireIncludes(siteCss, '.hero-proof-item + .hero-proof-item', 'docs/assets/site.css')
requireIncludes(siteCss, 'border-left: 1px solid rgba(255, 250, 240, 0.16);', 'docs/assets/site.css')
requireIncludes(siteCss, 'padding-left: clamp(22px, 2.5vw, 36px);', 'docs/assets/site.css')
...
requireIncludes(index, '<strong>70 scoped starter issues are open.</strong>', 'docs/index.html')

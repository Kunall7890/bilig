...
requireIncludes(starterIssues, '110 issues are currently available for a new contributor to claim.', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/373', 'docs/starter-issues.md')
requireIncludes(llms, 'https://github.com/proompteng/bilig/pull/373', 'docs/llms.txt')
...
requireIncludes(starterIssues, '#385: docs(google-sheets): add a Sheets API handoff checklist', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, '#383: docs(xlsx): add a sanitized Excel oracle summary sample', 'docs/starter-issues.md')

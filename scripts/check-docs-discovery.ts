...
requireIncludes(starterIssues, '105 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '101 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '5 starter issues are code or test tasks rather than docs-only tasks.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '4 open starter issues already have active pull requests.', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, '#364: test(core): add quoted semicolon CSV fixture', 'docs/starter-issues.md')
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/349', 'docs/starter-issues.md')
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/351', 'docs/starter-issues.md')
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/352', 'docs/starter-issues.md')
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/353', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, '#347: docs(storage): add plain node-postgres WorkPaper JSON persistence recipe', 'docs/starter-issues.md')
...
for (const required of [
  ...
  'marked `@bilig/headless@0.14.2` as the',

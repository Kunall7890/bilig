...
requireIncludes(llms, 'agent rule chooser: https://proompteng.github.io/bilig/agent-rule-chooser.html', 'docs/llms.txt')
...
requireIncludes(llmsFull, '## Agent WorkPaper Handoff', 'docs/llms-full.txt')

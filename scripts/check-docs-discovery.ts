...
requireIncludes(starterIssues, '5 open starter issues already have active pull requests.', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, '#370: test(examples): add malformed CSV fixture check to the csv-shaped smoke', 'docs/starter-issues.md')
...
requireIncludes(starterIssues, 'https://github.com/proompteng/bilig/pull/365', 'docs/starter-issues.md')

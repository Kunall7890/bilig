...
for (const required of [
  ...
  `mcp.so                          | Submitted for maintainer review; issue body refreshed for \`${headlessPackageVersion}\``,
  `Cline MCP Marketplace           | Submitted for maintainer review; issue body refreshed for \`${headlessPackageVersion}\``,

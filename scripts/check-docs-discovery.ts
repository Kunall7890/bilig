...
requireIncludes(starterIssues, '93 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '93 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')

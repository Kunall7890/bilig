...
requireIncludes(starterIssues, '100 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '100 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')

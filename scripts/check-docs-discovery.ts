...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-7" />', 'docs/index.html')
...
requireIncludes(index, '<strong>55 small issues are ready to pick up.</strong>', 'docs/index.html')

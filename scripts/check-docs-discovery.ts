...
requireIncludes(index, 'The checked result is narrow and public', 'docs/index.html')
requireIncludes(index, 'Check the exact workload before you use the number.', 'docs/index.html')
...
requireIncludes(index, 'p95 is 1.043x here', 'docs/index.html')

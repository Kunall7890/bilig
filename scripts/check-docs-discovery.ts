...
requireIncludes(starterIssues, '99 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '99 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')

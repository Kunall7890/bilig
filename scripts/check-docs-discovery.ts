...
for (const required of [
  ...
  'Live, `0.20.0` publish workflow succeeded; public API may lag',
  ...
  'public Registry API can lag after a successful\npublish',
  ...
  'claimed Glama Dockerfile\nadmin page is staged with the npm-backed file-mode config',
  'Node.js version: `24`',
  `@bilig/headless@${headlessPackageVersion}`,
  'CMD arguments',
  ...
  'Registry API search still showed Bilig WorkPaper entry version `0.19.3` with\n`isLatest: true` immediately after the publish',
  'https://github.com/proompteng/bilig/actions/runs/26007468036',

...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-17" />', 'docs/index.html')
...
requireIncludes(index, 'See the file. Rerun the command.', 'docs/index.html')
requireIncludes(index, 'One p95 lookup case is slower than', 'docs/index.html')
requireIncludes(index, 'Quote it only after rerunning the command.', 'docs/index.html')
...
requireIncludes(index, 'The artifact, the caveat, and the rerun command.', 'docs/index.html')
requireIncludes(index, 'Small docs, examples, and integration tasks.', 'docs/index.html')
...
requireIncludes(starterIssues, '77 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '69 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')
...
requireIncludes(llms, '77 open first-timers-only issues, 69 generally available, 8 already in review', 'docs/llms.txt')
...
const currentStarterIssueNumbers = [
  ...
  282, 283, 284, 285, 286, 287, 288, 289, 290, 292, 293, 294, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306,
]

...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-23" />', 'docs/index.html')
...
requireIncludes(index, 'The benchmark is checked in.', 'docs/index.html')
requireIncludes(index, 'The current artifact shows 46 of 46 comparable mean rows ahead of HyperFormula', 'docs/index.html')
requireIncludes(index, 'Mean latency only. This is not a promise that every workbook, formula, or p95 row is faster.', 'docs/index.html')
...
requireIncludes(index, '<dd>46 / 46 comparable mean rows</dd>', 'docs/index.html')
requireIncludes(index, 'The checked-in JSON is the thing to inspect in review, not a screenshot of the number.', 'docs/index.html')
requireIncludes(index, 'p95 is 1.043x', 'docs/index.html')
requireIncludes(index, 'That slower row stays visible because it matters if your workload looks like it.', 'docs/index.html')
...
requireIncludes(index, 'Install it. Change one cell. Check the total.', 'docs/index.html')
...
requireNotIncludes(index, 'Fast where the benchmark says so. Clear where it does not.', 'docs/index.html')
requireNotIncludes(index, 'Rerun the command before using the number in your own docs.', 'docs/index.html')
requireNotIncludes(index, 'Artifact summary, caveat, and rerun instructions.', 'docs/index.html')
requireNotIncludes(index, 'Run the benchmark yourself.', 'docs/index.html')
requireNotIncludes(index, 'Do not use this as a blanket speed claim.', 'docs/index.html')
requireNotIncludes(index, 'Small docs, examples, and integration tasks for first PRs.', 'docs/index.html')
requireNotIncludes(index, 'Known gaps are documented in public before they become surprises.', 'docs/index.html')
requireNotIncludes(index, 'Everything public, including the rough edges.', 'docs/index.html')
requireNotIncludes(index, 'Try the package before you trust the page.', 'docs/index.html')

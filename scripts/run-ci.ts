...
const generatedSourceChecks: readonly CiTask[] = [
  ...
  tsxScript('public agent start rules published-package check', 'scripts/check-public-agent-start-rules.ts', '--allow-release-pending'),
  ...
  allCompleted.push(
    ...(await runSequential('static direct checks', [
      ...
      direct(
        ...
        workspaceBin('vitest'),
        'run',
        'scripts/__tests__/dependency-policy.test.ts',
        '--configLoader',
        'runner',
      ),

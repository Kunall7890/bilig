...
export async function requireFastMcpWorkpaperClientDiscovery(context: FastMcpWorkpaperClientDiscoveryContext): Promise<void> {
  ...
  await Promise.all(
    ['README.md', 'fastmcp_workpaper_client.py', 'mcp.json', 'scripts/check-client.py'].map((sourceFile) =>
  ...
  requireIncludes(fastmcpWorkpaperClient, '--transport stdio', 'docs/fastmcp-workpaper-client.md')
  requireIncludes(fastmcpWorkpaperClient, 'Summary!B3 = 96000', 'docs/fastmcp-workpaper-client.md')
  requireIncludes(fastmcpWorkpaperClient, '"transport": "stdio"', 'docs/fastmcp-workpaper-client.md')
  requireIncludes(
  ...
  requireIncludes(fastmcpWorkpaperClient, 'https://gofastmcp.com/clients/transports', 'docs/fastmcp-workpaper-client.md')
  ...
  requireIncludes(
    ...
    'FastMCP Python client for hosted and local stdio checks',

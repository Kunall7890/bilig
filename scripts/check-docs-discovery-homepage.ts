...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<title>bilig - Headless Workbooks for TypeScript Services</title>',
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-14-12" />',
      '<link rel="stylesheet" href="./assets/product-demo.css?v=2026-05-14-3" />',
      'Workbook models for TypeScript services.',
      'Use a workbook when the calculation is easiest to review as cells and formulas.',
      'TypeScript examples',
      ...
      'One duplicate-lookup p95 row is slower, and it stays',

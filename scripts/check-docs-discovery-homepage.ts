...
export function requireHomepageDiscovery(index: string, siteCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-28" />',
      ...
      'The current WorkPaper vs HyperFormula suite has WorkPaper ahead',
      'pnpm workpaper:bench:competitive:check',
      '<dd>46 / 46 mean rows</dd>',
      'Not a blanket claim for every workbook.',
      'packages/benchmarks/baselines/<wbr />workpaper-vs-hyperformula.json',
      'Benchmark drift becomes a normal review diff.',
      '<code>lookup-approximate-duplicates</code> p95 1.043x',
      'If approximate lookup with duplicate keys matters to your workload',

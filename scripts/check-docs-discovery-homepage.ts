...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      'Start with <a href="https://www.npmjs.com/package/@bilig/headless">@bilig/headless</a>',
      '<a href="#runtime">Runtime</a>',
      '<a href="#install">Install</a>',
      '<a href="#mcp">Agents</a>',
      '<a href="#benchmark">Benchmark</a>',
      '<a href="#docs">Docs</a>',
      '<a class="button primary" href="https://www.npmjs.com/package/@bilig/headless">Install headless</a>',
      ...
      '"afterRestore": <span class="num">96000</span>',

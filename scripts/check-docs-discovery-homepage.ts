...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<title>bilig - Fresh XLSX Formula Readback in Node</title>',
      ...
      '<p class="eyebrow">XLSX Cache Doctor is live on GitHub Marketplace</p>',
      '<h1 id="hero-title" class="hero-title">Stop stale XLSX formulas before they reach main.</h1>',
      "When a script edits an input cell, Excel's cached result can lie.",
      'Bilig recalculates the workbook',
      'without Excel, LibreOffice, or browser automation.',
      ...
      'Find stale workbook caches in pull requests.',
      ...
      'an XLSX proof',
      'a Node service',
      'an agent workbook contract',
      '<a href="https://context7.com/proompteng/bilig">Ask docs</a>',
      '<a href="#packages">Packages</a>',
      '<a class="button primary" href="https://github.com/marketplace/actions/xlsx-cache-doctor">Use the Marketplace Action</a>',

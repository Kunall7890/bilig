...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      'npm exec --package @bilig/xlsx-formula-recalc -- xlsx-cache-doctor pricing.xlsx --json',
      'Diagnose stale XLSX formula caches without Excel, LibreOffice, or browser automation.',
      "workbooks: '**/*.xlsx'",
      'fail-on-stale',
      'Already own workbook state in code?',
      '<a href="#packages">Start</a>',
      '<a href="#install">WorkPaper</a>',
      '<a href="./xlsx-cache-doctor-github-action.html">Action</a>',
      '<a class="button primary" href="https://github.com/marketplace/actions/xlsx-cache-doctor">Use the Action</a>',
      '<a class="button" href="./eval-workpaper-service.html">Build an API</a>',
      '<a class="button" href="./eval-agent-mcp.html">Use with agents</a>',
      '<h2 id="packages-title">Start from the boundary you actually own.</h2>',

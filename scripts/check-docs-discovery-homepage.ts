...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<meta property="og:image:alt" content="bilig XLSX cache doctor and WorkPaper runtime preview" />',
      ...
      '<meta name="twitter:image:alt" content="bilig XLSX cache doctor and WorkPaper runtime preview" />',
      ...
      '<h1 id="hero-title" class="hero-title">Catch stale XLSX formulas.</h1>',
      'SheetJS, ExcelJS, and xlsx-populate can write the file and still leave old cached formula values behind.',
      'Bilig checks the\n            workbook locally before your API, queue worker, CI job, or agent trusts it.',
      ...
      'See the formula cell, stale cached value, fresh recalculated value, and exact cell address.',
      'Existing <code>.xlsx</code> file? Start with the cache doctor.',
      '<a href="#market">Who needs it</a>',
      '<a href="#install">Quickstart</a>',
      '<a href="#mcp">Agent tools</a>',
      '<a href="./xlsx-formula-recalculation-node.html">XLSX</a>',
      '<a href="#docs">Docs</a>',
      '<a class="button primary" href="./eval-xlsx-cache-doctor.html">Run cache doctor</a>',
      '<a class="button" href="./xlsx-cache-doctor-github-action.html">Add the Action</a>',
      '<a class="button" href="https://www.npmjs.com/package/@bilig/xlsx-formula-recalc">XLSX npm</a>',
      '<a class="button" href="./eval-workpaper-service.html">Use WorkPaper</a>',
      '<strong>1 stale formula cache</strong>',
      '<dt>Cell</dt>',
      '<dd><code>Sheet1!B61</code></dd>',
      '<dt>Cached</dt>',
      '<dt>Recalculated</dt>',
      '<h2 id="market-title">Teams that read XLSX formula results in Node.</h2>',
      'The risky moment is boring: a script edits input cells, saves the workbook, then production reads a cached formula value',
      ...
      '<code>xlsx-cache-doctor workbook.xlsx --json</code>',
      ...
      'Run the cache doctor first.',
      'No account, no server, no spreadsheet UI.',
      'npm exec --package @bilig/xlsx-formula-recalc@latest --',
      'xlsx-cache-doctor --demo --json',
      ...
      'Start with the cache check if the XLSX file is the contract.',
      'Find stale formula caches in an XLSX file.',
      'Add a report-only workbook check to pull requests.',
      ...
      'Run the cache doctor on one real workbook path:',
    ],
    'docs/index.html',
  )

...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-14-14" />',
      '<link rel="stylesheet" href="./assets/product-demo.css?v=2026-05-14-4" />',
      ...
      'bilig-hero-workbook-api.png?v=2026-05-14-2',
      'Edit cells. Read formulas. Save JSON.',
      'No grid required',

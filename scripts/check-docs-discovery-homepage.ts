...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<title>bilig - Spreadsheet Formula Readback for Node Agents</title>',
      'content="Bilig gives Node services and agents spreadsheet formula readback: write inputs, recalculate formulas, verify outputs, and save JSON."',
      'content="spreadsheet formula readback, headless workbook runtime, WorkPaper runtime, spreadsheet formulas Node.js, backend spreadsheet formulas, agent workbook automation, agent MCP tools, MCP spreadsheet tools, JSON WorkPaper persistence, @bilig/headless, @bilig/workpaper, XLSX formula recalculation Node.js"',
      '<meta name="robots" content="index, follow, max-image-preview:large" />',
      '<link rel="icon" type="image/svg+xml" href="./assets/favicon.svg" />',
      '<meta property="og:title" content="bilig - Spreadsheet Formula Readback for Node Agents" />',
      'property="og:description"',
      'content="Write workbook inputs, recalculate formulas, verify readback, and persist JSON from Node without spreadsheet UI automation."',
      '<meta property="og:image" content="https://proompteng.github.io/bilig/assets/github-social-preview.png?v=2026-05-15-2" />',
      '<meta property="og:image:alt" content="bilig headless WorkPaper runtime preview" />',
      '<meta name="twitter:card" content="summary_large_image" />',
      '<meta name="twitter:title" content="bilig - Spreadsheet Formula Readback for Node Agents" />',
      'name="twitter:description"',
      '<meta name="twitter:image" content="https://proompteng.github.io/bilig/assets/github-social-preview.png?v=2026-05-15-2" />',
      '<meta name="twitter:image:alt" content="bilig headless WorkPaper runtime preview" />',
      ...
      '<p class="eyebrow">Headless WorkPaper runtime</p>',
      '<h1 id="hero-title" class="hero-title">Run workbook rules in Node.</h1>',
      'Bilig gives services and agents a workbook API: write inputs, recalculate formulas, read outputs, and save JSON.',
      'Spreadsheet formula readback before production code or an agent trusts the result',
      'Agent MCP tool contracts',
      'tools when saved files are still the contract.',
      ...
      './xlsx-cache-doctor-github-action.html',
      ...
      '<a class="button" href="./eval-agent-mcp.html">Agent API</a>',
      '<a class="button" href="./xlsx-formula-recalculation-node.html">XLSX bridge</a>',
      ...
      '<code>npm install @bilig/headless</code>',
      ...
      'Give agents tools, not a spreadsheet screen.',
      ...
      'Install the lower-level headless package.',
      'Check committed workbook files in pull requests.',
      'Run a WorkPaper in a service.',
      'Give an agent a workbook API.',
  ...
  requireNoIncludes(
    ...
    [
      ...
      '<title>bilig - Headless WorkPaper runtime for Node</title>',
      '<h1 id="hero-title" class="hero-title">Run spreadsheet logic in Node.</h1>',
      '<p class="eyebrow">Headless WorkPaper runtime for Node</p>',

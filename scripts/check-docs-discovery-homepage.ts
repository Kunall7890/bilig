...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<p class="eyebrow">Start with the XLSX you already have</p>',
      '<h1 id="hero-title" class="hero-title">Fix stale XLSX formulas in Node.</h1>',
      'SheetJS, ExcelJS, and xlsx-populate can write the file and still leave the formula cache stale.',
      'Bilig recalculates the workbook',
      'before your API, queue worker, or CI job trusts it.',
      ...
      'The shortest proof for SheetJS, ExcelJS, and xlsx-populate users.',
      ...
      '<a class="button primary" href="./stale-xlsx-formula-cache-node.html">Read the stale-value guide</a>',

...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<h1 id="hero-title" class="hero-title">Spreadsheet logic without Excel.</h1>',
      'Edit cells, recalculate formulas, read verified values, and save JSON from Node.',
      ...
      'Use workbook formulas behind services and agent tools.',
      ...
      '<a class="button primary" href="#install">Install WorkPaper</a>',

...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      'content="WorkPaper runtime, spreadsheet formula readback, spreadsheet formulas Node.js, backend spreadsheet formulas, agent workbook automation, agent MCP tools, MCP spreadsheet tools, JSON WorkPaper persistence, @bilig/workpaper, Node service workbook automation"',

...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<title>bilig - Workbook Formulas in TypeScript</title>',
      '<meta name="robots" content="index, follow, max-image-preview:large" />',
      '<link rel="icon" type="image/svg+xml" href="./assets/favicon.svg" />',
      '<meta property="og:image" content="https://proompteng.github.io/bilig/assets/github-social-preview.png?v=2026-05-14-5" />',
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-14-11" />',
      '<link rel="stylesheet" href="./assets/product-demo.css?v=2026-05-14-2" />',
      'Spreadsheet formulas that run in TypeScript.',
      'For revenue models, budget checks, imports, and agent tools that are easier to review as cells.',
      ...
      'Node, no grid UI',
      'Keep the calculation as a workbook.',
      'If a pricing rule, import check, payout, or budget model is clearest as rows and formulas',
      'Write the input.',
      'Read the result.',
      'Save the workbook.',
      'Try it in a blank Node project.',
      'checks that the calculated total survived the round trip.',
      'curl -fsSLo eval.ts \\\n  https://proompteng.github.io/bilig/npm-eval.ts',
      'More TypeScript examples live in',
      'Run it where the work already happens.',
      'Route handler, queue worker, CLI, or MCP server: load the workbook',
      'Benchmark, with the caveat beside it.',
      'The checked JSON has bilig ahead on every comparable mean-latency row.',
      'One duplicate-lookup p95 row is slower and is called',
      ...
      'Starter issues',
      'benchmark critique',
      'Start with the path closest to your code.',
  ...
  requireAllIncludes(
    ...
    [
      '.hero-media {\n  justify-self: end;',
      '.product-frame {\n  overflow: hidden;\n  max-width: 100%;',
      '.demo-body {\n  display: grid;\n  grid-template-columns: minmax(240px, 0.95fr) minmax(230px, 0.74fr);',
  ...
  requireNoIncludes(
    ...
    [
      ...
      '46/46 on mean latency. One p95 case is slower.',

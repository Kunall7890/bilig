...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<title>bilig - Headless spreadsheet engine for Node services</title>',
      ...
      '<p class="eyebrow">Workbook runtime</p>',
      '<h1 id="hero-title" class="hero-title">Headless spreadsheet engine for Node services and agents.</h1>',
      'Edit cells. Recalculate. Save JSON.',
      ...
      'The checked JSON has bilig ahead on most comparable mean-latency rows.',
      'The worst p95 holdout is named beside the number.',
      'workpaper-vs-hyperformula.json',
      'current run',
      'comparable mean rows',
      'pnpm workpaper:bench:competitive:check',
      '<strong>48/57</strong>',
      '48 of 57 comparable mean-latency rows are faster in the checked file.',
      'Structural append formula rows is the worst p95',

...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      'When a business rule still needs cell review, keep it in a workbook.',
      ...
      'Use it for pricing rules, payout checks, quote approvals, import validation, and agent tools.',
      ...
      '<a class="button" href="./try-bilig-headless-in-node.html">Run the quickstart</a>',
      '<a class="button" href="./serverless-workpaper-api-route.html">Build a Node service</a>',

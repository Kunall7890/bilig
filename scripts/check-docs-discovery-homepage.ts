...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      '<h1 id="hero-title" class="hero-title">Formula workbooks for Node services and agent tools.</h1>',
      'Edit cells. Recalculate. Verify readback. Save JSON.',
      '<a href="#packages">Packages</a>',
      '<code>npm i bilig-workpaper</code>',
      '<h2 id="packages-title">Install the package that matches the job.</h2>',
      '<code>npm install bilig-workpaper</code>',
      '<code>npm install xlsx-formula-recalc</code>',
      '<code>npm install exceljs exceljs-formula-recalc</code>',

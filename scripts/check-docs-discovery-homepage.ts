...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string, docsRoot: string): void {
  ...
  requireAllIncludes(
    ...
    [
      ...
      'Keep the rules in cells. Let a TypeScript service edit inputs, recalculate formulas, read the answer, and save the WorkPaper.',
      ...
      'For pricing, payouts, approvals, import checks, and agent tools.',
      'Already have an <code>.xlsx</code> file?',
      '<a href="#market">Who needs it</a>',
      '<a href="#install">Quickstart</a>',
      '<a href="#mcp">Agent tools</a>',
      '<a href="./xlsx-formula-recalculation-node.html">XLSX</a>',
      '<a href="#docs">Docs</a>',
      '<a class="button primary" href="https://www.npmjs.com/package/@bilig/headless">Install</a>',
      '<a class="button" href="./try-bilig-headless-in-node.html">Run sample</a>',
      '<a class="button" href="./serverless-workpaper-api-route.html">Node service</a>',
      '<strong>Quote approved</strong>',
      '<dt>Output</dt>',
      '<dd><code>Summary!B7</code></dd>',
      ...
      'Do the real loop first: install the runtime, write an input cell, read the calculated value, save JSON',
      'npm install @bilig/headless',
      ...
      'Put @bilig/headless behind a Node API.',
      ...
      'Start with the runtime if the service owns state.',

...
describe('projection helpers', () => {
  ...
  it('materializes authoritative cell_eval rows from the workbook engine, including styled blanks', async () => {
    ...
    engine.setRangeStyle({ sheetName: 'Sheet1', startAddress: 'B1', endAddress: 'C2' }, { fill: { backgroundColor: '#abcdef' } })
    engine.setRangeNumberFormat({ sheetName: 'Sheet1', startAddress: 'B1', endAddress: 'C2' }, { kind: 'number', code: '$#,##0.00' })

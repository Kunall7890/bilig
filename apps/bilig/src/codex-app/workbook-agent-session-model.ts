...
const workbookAgentRenderedVisibleSceneProofSchema = z.object({
  ...
  currentSceneEpochSignature: z.string().nullable().optional(),
  currentSceneOwnershipSignature: z.string().nullable(),
  presentedSceneEpochSignature: z.string().nullable().optional(),
  presentedSceneOwnershipSignature: z.string().nullable(),
  currentSceneEpoch: z.string().nullable().optional(),
  presentedSceneEpoch: z.string().nullable().optional(),
  currentFillHandleRevision: z.string().nullable().optional(),
  presentedFillHandleRevision: z.string().nullable().optional(),
  currentSelectionRevision: z.string().nullable().optional(),
  presentedSelectionRevision: z.string().nullable().optional(),
  currentViewportRevision: z.string().nullable().optional(),
  presentedViewportRevision: z.string().nullable().optional(),
  currentSemanticMutationRevision: z.string().nullable().optional(),
  presentedSemanticMutationRevision: z.string().nullable().optional(),
  currentWorkbookRevision: z.string().nullable().optional(),
  presentedWorkbookRevision: z.string().nullable().optional(),
  ...
  visibleSceneEpochMatchesPresentedFrame: z.boolean().optional(),

...
export function parsedEditorInputEquals(left: ParsedEditorInput, right: ParsedEditorInput): boolean {
...
export function parsedEditorInputMatchesSnapshot(parsed: ParsedEditorInput, snapshot: CellSnapshot): boolean {
...
export function sameCellContent(left: CellSnapshot, right: CellSnapshot): boolean {
  return parsedEditorInputEquals(parsedEditorInputFromSnapshot(left), parsedEditorInputFromSnapshot(right))
}

export function clampSelectionMovement(address: string, sheetName: string, movement: readonly [-1 | 0 | 1, -1 | 0 | 1]): string {
...
export function createRangeRef(sheetName: string, startRow: number, startCol: number, endRow: number, endCol: number): CellRangeRef {
  return {
    sheetName,

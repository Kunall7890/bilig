...
export async function previewWorkbookImport(input: PreviewWorkbookImportInput): Promise<ImportedWorkbookPreview> {
...
export async function finalizeWorkbookImport(input: FinalizeWorkbookImportInput): Promise<WorkbookLoadedResponse> {

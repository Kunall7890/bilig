...
export function applyStylePatch(baseStyle: Omit<CellStyleRecord, 'id'>, patch: CellStylePatch): Omit<CellStyleRecord, 'id'> {
...
function applyOptionalField<T extends object, K extends keyof T>(target: T, key: K, value: T[K] | null | undefined): void {
  if (value === undefined) {
    return
  }
  if (value === null) {

...
import { normalizeWorkbookSnapshotForSemanticComparison, type WorkbookSemanticComparableSnapshot } from '../semantics/index.js'
...
export function normalizeSnapshotForSemanticComparison(snapshot: WorkbookSnapshot): WorkbookSemanticComparableSnapshot {
  return normalizeWorkbookSnapshotForSemanticComparison(snapshot)
}

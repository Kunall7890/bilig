...
import { decodeWorkbookAgentPreviewSummary, type WorkbookAgentCommandBundle } from '../workbook-agent-bundles.js'
...
function createBundle(command: WorkbookAgentCommandBundle['commands'][number]): WorkbookAgentCommandBundle {
  return {
    id: 'bundle-1',
    documentId: 'doc-1',
    threadId: 'thr-1',

...
describe('workbookTheme', () => {
  ...
  test('keeps workbook point sizes exact while drawing glyphs on crisp whole CSS pixels', () => {
    ...
    expect(workbookDisplayFontCssPx(13.3333)).toBe(14)
    expect(workbookDisplayFontCssPx(13.3333, 1.25)).toBe(14)
    expect(workbookDisplayFontCssPx(13.3333, 1.5)).toBe(14)
    expect(workbookDisplayFontCssPx(13.3333, 2)).toBe(14)
    expect(workbookDisplayFontCssPx(14.6667)).toBe(15)
    expect(workbookDisplayFontPointSizeToCssPx(10)).toBe(14)
    expect(workbookDisplayFontPointSizeToCssPx(10, 2)).toBe(14)
    expect(workbookDisplayFontPointSizeToCssPx(11)).toBe(15)
    expect(workbookDisplayLineHeightCssPx(13.3333)).toBe(17)
    expect(workbookDisplayLineHeightCssPx(13.3333, 2)).toBe(17)

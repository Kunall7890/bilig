...
describe('workbookTheme', () => {
  test('uses a spreadsheet-stable font stack for every workbook text renderer', () => {
    ...
    expect(WORKBOOK_FONT_SANS).not.toContain('BlinkMacSystemFont')
    ...
    expect(WORKBOOK_FONT_SANS).not.toContain('Roboto')
  ...
  test('keeps workbook point sizes semantic while snapping box metrics to device pixels', () => {
    ...
    expect(workbookDisplayFontCssPx(13.3333, 1.25)).toBe(13.3333)
    expect(workbookDisplayFontCssPx(13.3333, 1.5)).toBe(13.3333)
    expect(workbookDisplayFontCssPx(13.3333, 2)).toBe(13.3333)
    expect(workbookDisplayFontCssPx(13.3333, 3)).toBe(13.3333)

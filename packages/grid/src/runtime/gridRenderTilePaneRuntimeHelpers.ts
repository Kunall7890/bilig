...
export function engineHasLocalProjectionRevision(engine: GridEngineLike): boolean {
...
export function resolveAcknowledgedVisibleDirtyPaneTileKeys(panes: readonly WorkbookRenderTilePaneState[]): readonly TileKey53[] {
  const keys: number[] = []

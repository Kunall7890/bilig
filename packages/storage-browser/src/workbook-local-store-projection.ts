...
import type { CellStyleRecord, WorkbookAxisEntrySnapshot } from '@bilig/protocol'
import type {
...
import {
  ...
  parseAxisEntrySnapshot,
  parseCellStyleRecord,
  parseViewportCellFromRow,
  type ViewportBounds,
} from './workbook-local-store-projection-parse.js'

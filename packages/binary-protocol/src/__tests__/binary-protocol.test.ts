...
import { WORKBOOK_SNAPSHOT_CONTENT_TYPE, createSnapshotChunkFrames, decodeFrame, encodeFrame } from '../index.js'
...
describe('binary protocol', () => {
  ...
  it('roundtrips conditional format deletion ops', () => {
    ...
    expect(decoded.batch.ops).toEqual([{ kind: 'deleteConditionalFormat', id: 'cf-1', sheetName: 'Sheet1' }])
  })

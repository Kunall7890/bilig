...
export const WorkbookAgentRenderedVisibleSceneProofSchema = Schema.Struct({
  ...
  currentSceneEpochSignature: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentSceneOwnershipSignature: Schema.Union(Schema.String, Schema.Null),
  presentedSceneEpochSignature: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedSceneOwnershipSignature: Schema.Union(Schema.String, Schema.Null),
  currentSceneEpoch: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedSceneEpoch: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentFillHandleRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedFillHandleRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentSelectionRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedSelectionRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentViewportRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedViewportRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentSemanticMutationRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedSemanticMutationRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  currentWorkbookRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  presentedWorkbookRevision: Schema.optionalWith(Schema.Union(Schema.String, Schema.Null), {}),
  ...
  visibleSceneEpochMatchesPresentedFrame: Schema.optionalWith(Schema.Boolean, {}),

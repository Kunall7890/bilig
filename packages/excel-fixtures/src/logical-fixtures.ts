...
export const canonicalLogicalFixtures: readonly ExcelFixtureCase[] = [
  ...
  fixture(
    'logical',
    'if-direct-logical-text-false',
    'IF coerces direct FALSE text as FALSE',
    '=IF("FALSE",1,2)',
    [],
    [output('A1', { kind: 'number', value: 2 })],
  ),
  fixture(
    'logical',
    'if-direct-logical-text-invalid',
    'IF rejects non-logical direct text',
    '=IF("x",1,2)',
    [],
  ...
  fixture(
    'logical',
    'ifs-direct-logical-text',
    'IFS coerces direct logical text conditions',
    '=IFS("FALSE",1,"TRUE",2)',
    [],
    [output('A1', { kind: 'number', value: 2 })],
  ),
  fixture(
    'logical',
    'and-direct-logical-text',
    'AND coerces direct logical text arguments',
    '=AND("TRUE","true")',
    [],
  ...
  fixture(
    'logical',
    'or-direct-logical-text',
    'OR coerces direct FALSE and empty text arguments',
    '=OR("FALSE","")',
    [],
    [output('A1', booleanExpected(false))],
  ),
  ...
  fixture(
    'logical',
    'xor-direct-logical-text',
    'XOR coerces direct logical text arguments',
    '=XOR("TRUE","FALSE","")',
    [],
    [output('A1', booleanExpected(true))],
  ),

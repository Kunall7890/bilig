...
export const TEXT_FIXTURES: readonly TextFixtureGroup[] = [
  ...
  },
  {
    ...
    cases: [
      ...
      {
        name: 'empty delimiter returns empty text from the front',
        args: [text('alpha'), text('')],
        expected: text(''),
      },
      {
      ...
      {
        name: 'empty delimiter returns whole text from the back',
        args: [text('alpha'), text(''), number(-1)],
        expected: text('alpha'),
      },
    ],
  },
  {
    ...
    cases: [
      ...
      {
        name: 'empty delimiter returns whole text from the front',
        args: [text('alpha'), text('')],
        expected: text('alpha'),
      },
      {
      ...
      {
        name: 'empty delimiter returns empty text from the back',
        args: [text('alpha'), text(''), number(-1)],
        expected: text(''),
      },
    ],
...
export const canonicalTextFixtures: readonly ExcelFixtureCase[] = [
  ...
  fixture(
    'find-empty-needle-start-past-text',
    'FIND empty needle rejects start beyond text',
    '=FIND("","abc",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),
  fixture(
    'findb-empty-needle-start-past-text',
    'FINDB empty needle rejects start beyond text',
    '=FINDB("","abc",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),
  fixture(
    'search-empty-needle-start-past-text',
    'SEARCH empty needle rejects start beyond text',
    '=SEARCH("","abc",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),
  fixture(
    'searchb-empty-needle-start-past-text',
    'SEARCHB empty needle rejects start beyond text',
    '=SEARCHB("","abc",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),
  ...
  fixture(
    'textbefore-empty-delimiter-front',
    'TEXTBEFORE empty delimiter returns empty text from the front',
    '=TEXTBEFORE("alpha","")',
    [],
    [output('A1', stringExpected(''))],
  ),
  fixture(
    'textbefore-empty-delimiter-back',
    'TEXTBEFORE empty delimiter returns whole text from the back',
    '=TEXTBEFORE("alpha","",-1)',
    [],
    [output('A1', stringExpected('alpha'))],
  ),
  fixture(
    'textbefore-match-end',
    'TEXTBEFORE match_end treats the end of text as a delimiter',
    '=TEXTBEFORE("alpha","-",1,0,1)',
    [],
    [output('A1', stringExpected('alpha'))],
  ),
  fixture(
    'textbefore-instance-past-text-length',
    'TEXTBEFORE rejects an instance number larger than text length',
    '=TEXTBEFORE("abc","-",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),
  ...
  fixture(
    'textafter-empty-delimiter-front',
    'TEXTAFTER empty delimiter returns whole text from the front',
    '=TEXTAFTER("alpha","")',
    [],
    [output('A1', stringExpected('alpha'))],
  ),
  fixture(
    'textafter-empty-delimiter-back',
    'TEXTAFTER empty delimiter returns empty text from the back',
    '=TEXTAFTER("alpha","",-1)',
    [],
    [output('A1', stringExpected(''))],
  ),
  fixture(
    'textafter-match-end',
    'TEXTAFTER match_end treats the end of text as a delimiter',
    '=TEXTAFTER("alpha","-",1,0,1)',
    [],
    [output('A1', stringExpected(''))],
  ),
  fixture(
    'textafter-instance-past-text-length',
    'TEXTAFTER rejects an instance number larger than text length',
    '=TEXTAFTER("abc","-",4)',
    [],
    [output('A1', errorExpected(ErrorCode.Value, '#VALUE!'))],
  ),

...
export const canonicalStatisticalFixtures: readonly ExcelFixtureCase[] = [
  ...
  fixture(
    ...
    'CONFIDENCE.NORM returns #NUM! for alpha outside the open unit interval',
    '=CONFIDENCE.NORM(0,1,10)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  fixture(
    'confidence-norm-size-truncates',
    'CONFIDENCE.NORM truncates the size argument before computing the half-width',
    '=CONFIDENCE.NORM(0.05,1,1.9)',
    [],
    [output('C1', numberExpected(1.959963984540054))],
  ),
  fixture(
    'confidence-legacy-standard-deviation-domain-error',
    'CONFIDENCE returns #NUM! for nonpositive standard deviation',
  ...
  fixture(
    'rank-nonzero-order',
    'RANK treats any nonzero order value as ascending',
    '=RANK(30,A1:A3,2)',
    [input('A1', 10), input('A2', 20), input('A3', 30)],
    [output('C1', numberExpected(3))],
  ),
  fixture(
    'rank-eq-basic',
  ...
  fixture(
    'rank-eq-nonzero-order',
    'RANK.EQ treats any nonzero order value as ascending',
    '=RANK.EQ(30,A1:A3,-1)',
    [input('A1', 10), input('A2', 20), input('A3', 30)],
    [output('C1', numberExpected(3))],
  ),
  ...
  fixture(
    'rank-avg-nonzero-order',
    'RANK.AVG treats any nonzero order value as ascending',
    '=RANK.AVG(10,A1:A4,2)',
    [input('A1', 10), input('A2', 10), input('A3', 20), input('A4', 30)],
    [output('C1', numberExpected(1.5))],
  ),
  fixture(
    'rank-ignores-nonnumeric-reference-values',
    'RANK ignores nonnumeric values in the reference array',
    '=RANK(20,A1:A6)',
    [input('A1', 10), input('A2', 'skip'), input('A3', true), input('A5', 20), input('A6', 30)],
    [output('C1', numberExpected(2))],
  ),
  fixture(
    'median-basic',
  ...
  fixture(
    'confidence-t-alpha-domain-error',
    'CONFIDENCE.T returns #NUM! for alpha outside the open unit interval',
    '=CONFIDENCE.T(1,1,10)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  fixture(
    'confidence-t-size-one-div0',
    'CONFIDENCE.T returns #DIV/0! when truncated size leaves zero degrees of freedom',
    '=CONFIDENCE.T(0.05,1,1)',
    [],
    [output('C1', errorExpected(ErrorCode.Div0, '#DIV/0!'))],
  ),
  fixture(
    'confidence-t-size-truncates',
    'CONFIDENCE.T truncates the size argument before computing the Student-t half-width',
    '=CONFIDENCE.T(0.05,1,2.9)',
    [],
    [output('C1', numberExpected(8.984643532093735))],
  ),
  fixture(
    'fisher-basic',
    'FISHER returns the Fisher transform for an in-domain correlation',
    '=FISHER(0.75)',
    [],
    [output('C1', numberExpected(0.9729550745276566))],
  ),
  fixture(
    'fisher-endpoint-domain-error',
    'FISHER returns #NUM! outside the open -1..1 interval',
    '=FISHER(1)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  fixture(
    'gamma-basic',
    'GAMMA returns the gamma function value for positive integers',
    '=GAMMA(5)',
    [],
  ...
  fixture(
    'gamma-negative-noninteger',
    'GAMMA keeps valid negative noninteger inputs numeric',
    '=GAMMA(-0.5)',
    [],
    [output('C1', numberExpected(-3.5449077018110318))],
  ),
  fixture(
    'gammaln-basic',
    'GAMMALN returns the natural logarithm of gamma for positive input',
    '=GAMMALN(4)',
    [],
    [output('C1', numberExpected(1.791759469228055))],
  ),
  fixture(
    'gammaln-nonpositive-num-error',
    'GAMMALN returns #NUM! for nonpositive input',
    '=GAMMALN(0)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  fixture(
    'gammaln-precise-nonpositive-num-error',
    'GAMMALN.PRECISE returns #NUM! for nonpositive input',
    '=GAMMALN.PRECISE(-0.5)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  ...
  fixture(
    'gamma-inv-zero-probability',
    'GAMMA.INV returns the lower finite endpoint for zero probability',
    '=GAMMA.INV(0,3,2)',
    [],
    [output('C1', numberExpected(0))],
  ),
  fixture(
    'gamma-inv-probability-domain-error',
    'GAMMA.INV returns #NUM! for probabilities outside the supported interval',
    '=GAMMA.INV(-0.1,3,2)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),
  ...
  fixture(
    ...
    'GAMMAINV returns #NUM! for nonpositive distribution parameters',
    '=GAMMAINV(0.5,0,2)',
    [],
    [output('C1', errorExpected(ErrorCode.Num, '#NUM!'))],
  ),

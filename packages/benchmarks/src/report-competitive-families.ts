...
export const EXPANDED_COMPARATIVE_FAMILY_GROUPS = {
  ...
  rebuild: ['rebuild-and-recalculate', 'rebuild-and-recalculate-large'],
  'runtime-restore': ['rebuild-runtime-from-snapshot', 'rebuild-runtime-from-snapshot-large'],
  ...
  'cross-sheet': ['cross-sheet-scalar-recalc', 'cross-sheet-aggregate-recalc', 'cross-sheet-dashboard-recalc'],
  'dirty-execution': [
    'single-edit-recalc',
    'single-edit-chain',
  ...
  'aggregate-2d': ['aggregate-2d-ranges', 'aggregate-2d-ranges-small', 'aggregate-2d-ranges-large'],
  'overlapping-aggregate': ['aggregate-overlapping-ranges', 'aggregate-overlapping-ranges-small'],
  'sliding-window-aggregate': ['aggregate-overlapping-sliding-window', 'aggregate-overlapping-sliding-window-wide'],
  'conditional-aggregation': [

...
describe('wasm kernel text/radix helpers', () => {
  it('keeps byte-oriented text helpers stable across refactors', async () => {
    ...
    const packed = packPrograms([
      ...
      [encodePushString(0), encodePushNumber(0), encodePushNumber(1), encodeCall(BuiltinId.Midb, 3), encodeRet()],
      [encodePushString(0), encodePushNumber(0), encodeCall(BuiltinId.Rightb, 2), encodeRet()],
      [encodePushString(3), encodePushString(0), encodePushNumber(0), encodeCall(BuiltinId.Findb, 3), encodeRet()],
      [encodePushString(2), encodePushString(1), encodeCall(BuiltinId.Searchb, 2), encodeRet()],
      [encodePushString(1), encodePushNumber(0), encodePushNumber(1), encodePushString(4), encodeCall(BuiltinId.Replaceb, 4), encodeRet()],
    ])

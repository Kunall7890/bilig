...
describe('lookup order-statistics builtins', () => {
  it('supports PROB and TRIMMEAN with validation-heavy edge cases', () => {
    ...
    expect(PROB(cellRange([num(1), num(2)], 2, 1), cellRange([num(0.4)], 1, 1), num(1))).toEqual(err(ErrorCode.NA))
    expect(PROB(xValues, cellRange([num(0.1), num(0.2), num(0.3), num(0.5)], 4, 1), num(1))).toEqual(err(ErrorCode.Num))
    expect(PROB(xValues, cellRange([num(0), num(0.2), num(0.3), num(0.5)], 4, 1), num(1))).toEqual(err(ErrorCode.Num))
    ...
    expect(TRIMMEAN(cellRange([num(1), num(2)], 2, 1), num(1.1))).toEqual(err(ErrorCode.Num))
  ...
  it('covers order-statistics validation branches and rank variants', () => {
    ...
    expect(SMALL(sample, num(0))).toEqual(err(ErrorCode.Num))
    expect(LARGE(sample, num(99))).toEqual(err(ErrorCode.Num))
    expect(SMALL({ tag: ValueTag.Boolean, value: true }, num(1))).toEqual(err(ErrorCode.Num))
    expect(LARGE({ tag: ValueTag.Boolean, value: true }, num(1))).toEqual(err(ErrorCode.Num))
    expect(SMALL(text('2'), num(1))).toEqual(err(ErrorCode.Num))
    expect(LARGE(text('2'), num(1))).toEqual(err(ErrorCode.Num))
    ...
    expect(PERCENTILE(cellRange([], 0, 0), num(0.5))).toEqual(err(ErrorCode.Num))
    expect(PERCENTILE_EXC(ordered, num(0))).toEqual(err(ErrorCode.Num))
    ...
    expect(PERCENTRANK(cellRange([], 0, 0), num(1))).toEqual(err(ErrorCode.Num))
    expect(PERCENTRANK(cellRange([num(1)], 1, 1), num(1))).toEqual(err(ErrorCode.Value))
    expect(PERCENTRANK(ordered, num(8), num(0))).toEqual(err(ErrorCode.Num))
    ...
    expect(QUARTILE_EXC(ordered, num(0))).toEqual(err(ErrorCode.Num))
    expect(QUARTILE_EXC(ordered, num(4))).toEqual(err(ErrorCode.Num))
  ...
  it('returns value errors for missing required order-statistic arguments instead of throwing', () => {
    ...
    expect(SMALL(cellRange([], 0, 0), num(1))).toEqual(err(ErrorCode.Num))
    ...
    expect(PERCENTILE(ordered, num(-0.01))).toEqual(err(ErrorCode.Num))
    expect(PERCENTILE(ordered, num(1.01))).toEqual(err(ErrorCode.Num))
    expect(PERCENTILE_EXC(ordered, num(0.01))).toEqual(err(ErrorCode.Num))
    expect(PERCENTILE_EXC(ordered, num(0.99))).toEqual(err(ErrorCode.Num))
    ...
    expect(QUARTILE(ordered, num(-1))).toEqual(err(ErrorCode.Num))
    expect(QUARTILE(ordered, num(5))).toEqual(err(ErrorCode.Num))
    expect(QUARTILE(cellRange([], 0, 0), num(1))).toEqual(err(ErrorCode.Num))
    ...
    expect(PROB(ordered, cellRange([num(0.2), num(0.2), num(-0.1), num(0.7)], 4, 1), num(1))).toEqual(err(ErrorCode.Num))
    expect(PROB(ordered, cellRange([num(0.2), num(0.2), num(1.1), num(-0.5)], 4, 1), num(1))).toEqual(err(ErrorCode.Num))
    ...
    expect(TRIMMEAN(ordered, num(-0.1))).toEqual(err(ErrorCode.Num))

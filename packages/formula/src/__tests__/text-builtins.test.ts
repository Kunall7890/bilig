...
describe('text builtins', () => {
  ...
  it('covers scalar text builtin validation and boundary branches', () => {
    ...
    expect(getTextBuiltin('REPLACE')?.(text('abc'), number(8), number(1), text('z'))).toEqual(text('abc'))
    ...
    expect(getTextBuiltin('REPLACEB')?.(text('abc'), number(8), number(1), text('z'))).toEqual(text('abc'))

...
import {
  buildParsedCellReferenceInfo,
  buildParsedDependenciesFromReferences,
  buildParsedSymbolicRangesFromReferences,
  collectParsedDependencyReferencesFromAst,
} from './compiler-reference-metadata.js'
import type {
  CompiledFormula,
...
export { FORMULA_SPILL_PRODUCING_FUNCTION_NAMES, FORMULA_VOLATILE_FUNCTION_NAMES } from './compiler-analysis.js'

...
const fullWeekdayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'] as const
...
function formatTextBuiltinValue(deps: TextFormatBuiltinDeps, value: CellValue, formatText: string): CellValue {
...
function parseNumberValueText(input: string, decimalSeparator: string, groupSeparator: string): number | undefined {

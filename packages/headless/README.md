...
| Formula workbook state belongs in a service or agent tool     | `npm install @bilig/workpaper`                                | `npm exec --package @bilig/workpaper@0.62.0 -- bilig-agent-challenge` prints `verified: true`.                                                |
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.62.0/bilig-workpaper.mcpb)).
- Choosing the stack:

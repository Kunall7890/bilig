...
```sh
npm exec --package @bilig/headless@0.40.35 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
Current checked npm footprint for `@bilig/headless@0.40.35`:

- Pack dry run: `670 kB` tarball, `4.11 MB` unpacked, `690` package entries.
...
```sh
npm exec --package @bilig/headless@0.40.35 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.40.35 -- bilig-workpaper-mcp
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.40.35/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.40.35/bilig-workpaper.mcpb)).
- Choosing the stack:

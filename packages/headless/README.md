...
```sh
npm exec --package @bilig/headless@0.130.6 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.130.6 -- bilig-agent-challenge --json
npm exec --package @bilig/headless@0.130.6 -- bilig-mcp-challenge --json
```
...
```sh
npm exec --package @bilig/headless@0.130.6 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.130.6 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.130.6 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

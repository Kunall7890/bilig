...
```sh
npm exec --package @bilig/headless@0.119.2 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
Current checked npm footprint for `@bilig/headless@0.119.2`:
...
```sh
npm exec --package @bilig/headless@0.119.2 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.119.2 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.119.2 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

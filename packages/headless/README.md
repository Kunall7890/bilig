...
```sh
npm exec --package @bilig/headless@0.160.2 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
```sh
npm exec --package @bilig/headless@0.160.2 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.160.2 -- bilig-workpaper-mcp
...
npm exec --package @bilig/headless@0.160.2 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx
npm exec --package @bilig/headless@0.160.2 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx --workpaper ./.bilig/pricing.workpaper.json --writable

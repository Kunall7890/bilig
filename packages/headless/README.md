...
| Formula workbook state belongs in a service or agent tool     | `npm install @bilig/workpaper`                                | `npm exec --package @bilig/workpaper@0.71.0 -- bilig-agent-challenge` prints `verified: true`.                                                |
...
Current checked npm footprint for `@bilig/headless@0.71.0`:
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.71.0/bilig-workpaper.mcpb)).
- Choosing the stack:

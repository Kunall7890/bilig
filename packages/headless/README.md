...
```sh
npm exec --package @bilig/headless@0.40.20 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.40.20 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.40.20 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.40.20`:

- Pack dry run: `653 kB` tarball, `3.99 MB` unpacked, `657` package entries.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.40.20/bilig-workpaper.mcpb)).
- Choosing the stack:

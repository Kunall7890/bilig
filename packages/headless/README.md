...
Current checked npm footprint for `@bilig/headless@0.141.0`:
...
```sh
npm exec --package @bilig/headless@0.141.0 -- bilig-agent-challenge --json
npm exec --package @bilig/headless@0.141.0 -- bilig-mcp-challenge --json
```

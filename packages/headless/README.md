...
```sh
npm exec --package @bilig/headless@0.119.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.119.1 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.119.1 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.119.1`:
...
```sh
npm exec --package @bilig/headless@0.119.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.119.1 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.119.1 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

...
```sh
npm exec --package @bilig/headless@0.161.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
- Pack dry run: `849 kB` tarball, `5.19 MB` unpacked, `817` package entries.
...
```sh
npm exec --package @bilig/headless@0.161.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.161.0 -- bilig-workpaper-mcp
...
npm exec --package @bilig/headless@0.161.0 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx
npm exec --package @bilig/headless@0.161.0 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx --workpaper ./.bilig/pricing.workpaper.json --writable

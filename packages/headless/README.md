...
Current checked npm footprint for `@bilig/headless@0.164.8`:
...
```sh
npm exec --package @bilig/headless@0.164.8 -- bilig-agent-challenge --json
npm exec --package @bilig/headless@0.164.8 -- bilig-mcp-challenge --json
```
...
```sh
npm exec --package @bilig/headless@0.164.8 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.164.8 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.164.8 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
npm exec --package @bilig/headless@0.164.8 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx
npm exec --package @bilig/headless@0.164.8 -- bilig-workpaper-mcp --from-xlsx ./pricing.xlsx --workpaper ./.bilig/pricing.workpaper.json --writable

...
| Build from service data      | [`npm run json-records`](https://github.com/proompteng/bilig/tree/main/examples/headless-workpaper#json-records-input), [workbook-automation-examples-node guide](https://proompteng.github.io/bilig/workbook-automation-examples-node.html), [Node service recipe](https://github.com/proompteng/bilig/blob/main/docs/node-service-workpaper-recipe.md), [Express/Fastify/Hono/Oak/Hapi/AdonisJS adapters](https://proompteng.github.io/bilig/node-framework-workpaper-adapters.html)            |
| Wrap agent tools             | [`npm run agent:tool-call`](https://github.com/proompteng/bilig/tree/main/examples/headless-workpaper#agent-tool-call-loop), [`npm run agent:openai-responses`](https://github.com/proompteng/bilig/tree/main/examples/headless-workpaper#openai-responses-tool-wrapper), [OpenAI Responses guide](https://proompteng.github.io/bilig/openai-responses-workpaper-tool-call.html), and [framework adapter guide](https://proompteng.github.io/bilig/vercel-ai-sdk-langchain-spreadsheet-tool.html) |
...
| Normalize CSV-shaped service input   | `npm run csv-shaped`                 | [CSV shaped input](https://github.com/proompteng/bilig/tree/main/examples/headless-workpaper#csv-shaped-input)                             |

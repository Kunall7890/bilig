...
| Formula workbook state belongs in a service or agent tool     | `npm install @bilig/workpaper`                                | `npm exec --package @bilig/workpaper@0.92.0 -- bilig-agent-challenge` prints `verified: true`.                                                |
...
```sh
npm exec --package @bilig/headless@0.92.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.92.0 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.92.0 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.92.0`:

- Pack dry run: `790 kB` tarball, `4.85 MB` unpacked, `774` package entries.
...
```sh
npm exec --package @bilig/headless@0.92.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.92.0 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.92.0 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.92.0/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.92.0/bilig-workpaper.mcpb)).
- Choosing the stack:

...
```sh
npm exec --package @bilig/headless@0.25.6 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.25.6 -- bilig-agent-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.25.6`:

- Pack dry run: `490 kB` tarball, `2.95 MB` unpacked, `480` package entries.
...
```sh
npm exec --package @bilig/headless@0.25.6 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.25.6 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.25.6 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.25.6/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.25.6/bilig-workpaper.mcpb)).
- Choosing the stack:

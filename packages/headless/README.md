...
- Pack dry run: `491 kB` tarball, `2.96 MB` unpacked, `483` package entries.
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.25.7/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.25.7/bilig-workpaper.mcpb)).
- Choosing the stack:

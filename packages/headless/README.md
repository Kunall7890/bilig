...
| Formula workbook state belongs in a service or agent tool     | `npm install @bilig/workpaper`                                | `npm exec --package @bilig/workpaper@0.73.0 -- bilig-agent-challenge` prints `verified: true`.                                                |
...
```sh
npm exec --package @bilig/headless@0.73.0 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.73.0 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.73.0`:
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.73.0/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.73.0/bilig-workpaper.mcpb)).
- Choosing the stack:

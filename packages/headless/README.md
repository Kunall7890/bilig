...
```sh
npm exec --package @bilig/headless@0.40.39 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
Current checked npm footprint for `@bilig/headless@0.40.39`:

- Pack dry run: `681 kB` tarball, `4.18 MB` unpacked, `711` package entries.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.40.39/bilig-workpaper.mcpb)).
- Choosing the stack:

...
Current checked npm footprint for `@bilig/headless@0.18.21`:
...
- Run `pnpm workpaper:bench:competitive:check` from the repository. The
  ...
  [`79/100` comparable WorkPaper mean wins](https://github.com/proompteng/bilig/blob/main/docs/what-workpaper-benchmark-proves.md)
  and names the worst p95 holdout:
  `build-dense-literals-wide` at `3.047x`.

...
export function createN8nForecastProof(body: N8nForecastRequestBody = {}) {
  const sheetName = readOptionalString(body.sheetName, FORECAST_INPUTS_SHEET, 'sheetName')
  if (sheetName !== FORECAST_INPUTS_SHEET) {
    throw new Error(`Only ${FORECAST_INPUTS_SHEET} cells are editable in the n8n forecast demo`)
  }
...
export function buildN8nForecastWorkPaper(): WorkPaperInstance {

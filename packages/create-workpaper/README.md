...
Kiro, Roo Code, Zed, Junie, Aider conventions, Cline, Continue, Cascade/Devin, Windsurf rules, an OpenHands skill at
...
Claude Code, Cursor, Kiro, Roo Code, Zed (`.zed/settings.json`), Junie,

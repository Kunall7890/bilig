...
Roo Code, Junie, Aider conventions, Cline, Continue, Cascade/Devin, Windsurf rules, an OpenHands skill at
...
Claude Code, Cursor, Roo Code, Junie and VS Code MCP configs, a generic MCP config at

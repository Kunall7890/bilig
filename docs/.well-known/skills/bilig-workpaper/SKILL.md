...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.0", "--", "bilig-agent-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.0", "--", "bilig-mcp-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.0", "--", "bilig-formula-clinic", "./reduced.xlsx", "--cells", "Summary!B7,Inputs!B2"]
}
```

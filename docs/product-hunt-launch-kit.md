...
74/100 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `74/100` comparable mean-row
  claim and the slower build-mixed-content p95 caveat.

...
79/100 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `79/100` comparable mean-row
  claim and the slower structural-insert-columns-small p95 caveat.

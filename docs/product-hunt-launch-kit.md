...
75/100 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `75/100` comparable mean-row
  claim and the slower lookup-with-column-index-after-batch-write p95 caveat.

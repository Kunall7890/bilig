...
81/100 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `81/100` comparable mean-row
  claim and the slower structural-append-formula-rows p95 caveat.

...
72/100 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `72/100` comparable mean-row
  claim and the slower lookup-text-exact p95 caveat.

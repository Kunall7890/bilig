...
Latest execution snapshot on May 12, 2026 at `22:53:16Z`:

- GitHub surface: public repo, `24` stars, `4` forks, `30` open issues
- npm surface: `@bilig/headless@0.11.27`, MIT, TypeScript types, npm API

...
The `75/100` WorkPaper mean-win claim should become small, quotable artifacts:
...
3/ Benchmark caveat is public too: 75/100 comparable mean-latency rows are faster
in the checked file, lookup-with-column-index-after-batch-write is the visible p95 holdout,
...
The benchmark claim is intentionally narrow: the checked artifact has 75/100
comparable mean-latency wins against HyperFormula-style workloads,
lookup-with-column-index-after-batch-write is the visible p95 holdout, and UI rendering is

...
- Do not route new evaluator traffic to the older public DEV copy until it is
  ...
  checked package evidence is `@bilig/headless@0.48.0`, `98/100` comparable
  mean wins, and `97/100` mean+p95 wins.
...
The `98/100` WorkPaper mean-win claim should become small, quotable artifacts:
...
3/ Current benchmark artifact: 98/100 comparable mean-latency rows are faster
...
The benchmark claim is intentionally narrow: 98/100 comparable mean-latency

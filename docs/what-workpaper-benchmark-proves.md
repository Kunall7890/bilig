...
`49/57` mean-latency wins on scorecard-eligible comparable workloads. This is a
...
generated at `2026-05-16T10:52:22.842Z`.

The overall directional mean-ratio geomean is `0.6203840618525069`, and the
overall directional p95-ratio geomean is `0.640800826895162`. Ratios below
...
p95 ratio is `5.057668720382607`. The honest claim is `49/57` mean wins plus an
...
> bilig's WorkPaper benchmark currently records `49/57` mean wins against
...
> command, and an explicit p95 caveat. the claim is `49/57` mean wins for the

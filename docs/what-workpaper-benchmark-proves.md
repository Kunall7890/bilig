...
generated at `2026-05-16T12:31:19.965Z`.

The overall directional mean-ratio geomean is `0.6017031164855501`, and the
overall directional p95-ratio geomean is `0.6157166133420032`. Ratios below
...
p95 ratio is `1.8085843429631043`. The honest claim is `49/57` mean wins plus an

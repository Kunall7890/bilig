...
The overall directional mean-ratio geomean is `0.6772914986273257`, and the
overall directional p95-ratio geomean is `0.7105307977769327`. Ratios below
...
p95 ratio is `3.884806905124097`. The honest claim is `47/57` mean wins plus an

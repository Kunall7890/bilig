...
The overall directional mean-ratio geomean is `0.6103232497564816`, and the
overall directional p95-ratio geomean is `0.6215905729735544`. Ratios below
...
p95 ratio is `1.7829122340359367`. The honest claim is `49/57` mean wins plus an

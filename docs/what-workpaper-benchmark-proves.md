...
The overall directional mean-ratio geomean is `0.6436412107670894`, and the
overall directional p95-ratio geomean is `0.6787607258234833`. Ratios below
...
p95 ratio is `4.339309929183164`. The honest claim is `48/57` mean wins plus an

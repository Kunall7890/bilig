...
| Benchmark claim in this repo | External comparison target                                                           | Checked-in WorkPaper-vs-HyperFormula artifact records `73/100` mean wins on scorecard-eligible comparable workloads |
...
- `73/100` mean-latency wins on scorecard-eligible comparable workloads
- `54/73` public-lane mean wins

...
| Benchmark claim in this repo | External comparison target                                                           | Checked-in WorkPaper-vs-HyperFormula artifact records `96/100` mean wins on scorecard-eligible comparable workloads |
...
- `96/100` mean wins on scorecard-eligible comparable workloads
- `71/73` public-lane mean wins
- `25/27` holdout-lane mean wins
- an overall p95 geomean lead with five current comparable p95 holdouts

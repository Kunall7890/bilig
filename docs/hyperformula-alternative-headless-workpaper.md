...
| Benchmark claim in this repo | External comparison target | Checked-in WorkPaper-vs-HyperFormula artifact records `46/46` mean wins on scorecard-eligible comparable workloads |
...
- `38/38` public-lane mean wins
- `8/8` holdout-lane mean wins

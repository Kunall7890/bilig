...
```sh
npm exec --package @bilig/workpaper@0.45.0 -- bilig-agent-challenge
npm exec --package @bilig/workpaper@0.45.0 -- bilig-mcp-challenge
...
npm exec --package @bilig/workpaper@0.45.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

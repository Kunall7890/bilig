...
- WorkPaper package: `@bilig/headless` `0.16.25`
...
The overall directional mean-ratio geomean is `0.6338536341173324`. The overall
directional p95-ratio geomean is `0.6382583820811502`. Ratios below `1.0` mean
WorkPaper is faster for that metric.

The current worst mean row is `single-formula-edit-recalc`, with a mean ratio of
`2.199937243132268`. The current worst p95 row is `single-formula-edit-recalc`,
with a p95 ratio of `2.6077335546775857`. The headless leadership scorecard

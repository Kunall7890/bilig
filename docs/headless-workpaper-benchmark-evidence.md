...
- WorkPaper package: `@bilig/headless` `0.16.9`
...
The overall directional mean-ratio geomean is `0.6017031164855501`. The overall
directional p95-ratio geomean is `0.6157166133420032`. Ratios below `1.0` mean

...
- generated at `2026-05-16T15:00:03.359Z`
...
The overall directional mean-ratio geomean is `0.6772914986273257`. The overall
directional p95-ratio geomean is `0.7105307977769327`. Ratios below `1.0` mean
WorkPaper is faster for that metric.

The current worst mean row is `structural-delete-rows`, with a mean ratio of
`4.096998511495776`. The current worst p95 row is `structural-delete-rows`,
with a p95 ratio of `3.884806905124097`. The headless leadership scorecard

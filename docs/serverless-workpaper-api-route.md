...
Functions, Fastify, Hono, Oak, Hapi, AdonisJS, or another HTTP surface.

If the route is going into an existing Node service, use the runnable
[`Express, Fastify, Hono, Oak, Hapi, and AdonisJS adapter guide`](./node-framework-workpaper-adapters.md)

...
```sh
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.107.0/bilig-workpaper.mcpb
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.107.0/bilig-workpaper.mcpb.sha256

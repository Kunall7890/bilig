...
```sh
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.86.1/bilig-workpaper.mcpb
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.86.1/bilig-workpaper.mcpb.sha256

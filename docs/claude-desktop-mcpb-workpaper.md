...
```sh
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.90.3/bilig-workpaper.mcpb
curl -fsSLO https://github.com/proompteng/bilig/releases/download/libraries-v0.90.3/bilig-workpaper.mcpb.sha256

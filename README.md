...
```sh
npm exec --package @bilig/headless@0.33.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
```sh
npm exec --package @bilig/headless@0.33.1 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.33.1 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.33.1`:
...
`npm exec --package @bilig/headless@0.33.1 -- bilig-workpaper-mcp` when that is the
...
npm exec --package @bilig/headless@0.33.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.33.1 -- bilig-mcp-challenge
npm exec --package @bilig/headless@0.33.1 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.33.1 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

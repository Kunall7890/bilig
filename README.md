...
**Run spreadsheet logic inside Node services and agent tools.**

Bilig is a headless WorkPaper runtime for code that still needs workbook-shaped
...
For starter projects with agent instructions and MCP config:
...
Current checked npm footprint for `@bilig/headless@0.131.1`:

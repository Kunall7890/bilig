...
| XLSX inputs changed in Node; formula outputs must refresh before returning | `npm install xlsx-formula-recalc` | [XLSX formula recalculation in Node.js](docs/xlsx-formula-recalculation-node.md) |
...
```sh
npm exec --package @bilig/headless@0.32.3 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
```sh
npm exec --package @bilig/headless@0.32.3 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.32.3 -- bilig-mcp-challenge
```
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.32.3/bilig-workpaper.mcpb>.
...
Current checked npm footprint for `@bilig/headless@0.32.4`:

- Pack dry run: `497 kB` tarball, `2.99 MB` unpacked, `489` package entries.
...
`npm exec --package @bilig/headless@0.32.3 -- bilig-workpaper-mcp` when that is the
...
npm exec --package @bilig/headless@0.32.3 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.32.3 -- bilig-mcp-challenge
npm exec --package @bilig/headless@0.32.3 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.32.3 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

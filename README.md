...
| n8n, Dify, Flowise                                         | Workflow builders need formula readback without spreadsheet UI automation; use `@bilig/n8n-nodes-workpaper` or the upstream merged Dify plugin. | [n8n](docs/n8n-workpaper-formula-readback.md), [Dify](docs/dify-workpaper-formula-readback.md), [Flowise](docs/flowise-workpaper-formula-readback.md)                                                                     |

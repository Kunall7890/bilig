...
```sh
npm exec --package @bilig/headless@0.32.8 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
```sh
npm exec --package @bilig/headless@0.32.8 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.32.8 -- bilig-mcp-challenge
```
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.32.8/bilig-workpaper.mcpb>.
...
Current checked npm footprint for `@bilig/headless@0.32.8`:
...
`npm exec --package @bilig/headless@0.32.8 -- bilig-workpaper-mcp` when that is the
...
npm exec --package @bilig/headless@0.32.8 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.32.8 -- bilig-mcp-challenge
npm exec --package @bilig/headless@0.32.8 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.32.8 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable

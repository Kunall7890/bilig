...
| A public review needs the narrowest cache-doctor pitch                  | [Show HN XLSX Cache Doctor note](docs/show-hn-xlsx-cache-doctor.md) | one command, expected JSON, GitHub Action snippet, limits, and hard-case request.         |
...
| Public cache-doctor review    | [Show HN XLSX Cache Doctor note](docs/show-hn-xlsx-cache-doctor.md)                                                                                                                                                                                                                      | One shareable page has the stale-cache command, expected JSON, Action snippet, limits, and hard-case ask.   |

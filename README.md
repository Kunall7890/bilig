...
```sh
npm exec --package @bilig/headless@0.24.3 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
Current checked npm footprint for `@bilig/headless@0.24.3`:

- Pack dry run: `486 kB` tarball, `2.93 MB` unpacked, `474` package entries.
...
`npm exec --package @bilig/headless@0.24.3 -- bilig-workpaper-mcp` when that is the
